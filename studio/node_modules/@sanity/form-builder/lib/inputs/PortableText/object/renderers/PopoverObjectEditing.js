...
var ContentRoot = (0, _styledComponents.default)(_ui.Flex)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  overflow: hidden;\n  width: calc(100vw - 16px);\n  max-width: 320px;\n"])));
var Header = (0, _styledComponents.default)(_ui.Box)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  background-color: var(--card-bg-color);\n  box-shadow: 0 1px 0 var(--card-shadow-outline-color);\n  position: relative;\n  z-index: 10;\n  min-height: auto;\n"])));
var POPOVER_FALLBACK_PLACEMENTS = ['top', 'bottom'];

function getEditorElement(editor, editorPath) {
  var _ref = _portableTextEditor.PortableTextEditor.findByPath(editor, editorPath) || [],
      _ref2 = _slicedToArray(_ref, 1),
      editorObject = _ref2[0];
...
function PopoverObjectEditing(props) {
  var editorPath = props.editorPath,
      object = props.object;
  ...
  var _useState3 = (0, _react.useState)(() => getEditorElement(editor, editorPath)),
  ...
  return /*#__PURE__*/_react.default.createElement(Root, {
    ...
    portal: "default",
    ref: setRootElement,
    referenceElement: refElement || _debug.debugElement
  });
}
...
function Content(props) {
  ...
  (0, _ui.useClickOutside)(handleClose, [rootElement]);
  (0, _react.useEffect)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(ContentRoot, {
    direction: "column"
